...
class Settings(BaseSettings):
    ...
    APPLE_MUSIC_DEVELOPER_TOKEN_TTL_SECONDS: int = 15777000
    APPLE_MUSIC_STOREFRONT: str = "us"
    APPLE_MUSIC_API_BASE_URL: str = "https://api.music.apple.com"
    ...
    TIDAL_API_BASE_URL: str = "https://openapi.tidal.com/v2"
